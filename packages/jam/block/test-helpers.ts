...
export function testBlockHex() {
  return Compatibility.isGreaterThan(GpVersion.V0_6_4) ? testBlockData : testBlockData_0_6_4;
}
...
export function testWorkReportHex() {
  return Compatibility.isGreaterThan(GpVersion.V0_6_4) ? testWorkReportData : testWorkReportData_0_6_4;
}
