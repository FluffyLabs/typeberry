...
/**
 * Validates that a given number is within the allowed range for a work items count.
 *
 * @param len - The number to validate as a work items count.
 * @returns The validated number as a {@link WorkItemsCount}.
 *
 * @throws {Error} If {@link len} is less than {@link MIN_NUMBER_OF_WORK_ITEMS} or greater than {@link MAX_NUMBER_OF_WORK_ITEMS}.
 */
