...
describe('TruncatedHashDictionary', () => {
  ...
  it('should retrieve the value when using a truncated key for lookup', () => {
    ...
    const truncatedKey = Bytes.fromBlob(
      fullKey.raw.subarray(0, TRUNCATED_KEY_BYTES),
      TRUNCATED_KEY_BYTES,
    );
  ...
  it('should return undefined for a key with a different truncated prefix', () => {
    const insertedKey = Bytes.parseBytes('0x99999999999999999999999999999999999999999999999999999999999999ff', HASH_SIZE);
