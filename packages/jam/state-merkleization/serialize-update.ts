...
import { SafroleData, tryAsLookupHistorySlots, UpdatePreimage, UpdatePreimageKind, UpdateService, UpdateServiceKind, UpdateStorage, UpdateStorageKind, type ServicesUpdate, type State } from "@typeberry/state";
import type { StateKey } from "./keys";
import {serialize, StateCodec} from "./serialize";
import {Encode, Encoder} from "@typeberry/codec";
...
function *serializeRemovedServices(
  servicesRemoved: ServiceId[] | undefined
...
function getSafroleData(
  ...
  if (nextValidatorData === undefined || epochRoot === undefined || sealingKeySeries === undefined || ticketsAccumulator === undefined) {
