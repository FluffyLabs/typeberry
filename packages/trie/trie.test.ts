...
test("Trie", async () => {
	...
	await test("Leaf Node", () => {
		...
		const value = BytesBlob.parseBlob(
			"0x4227b4a465084852cd87d8f23bec0db6fa7766b9685ab5e095ef9cda9e15e49dff",
		);
	...
	await test("Non embedded leaf", () => {
		...
		trie.set(
			...
			BytesBlob.parseBlob(
				"0x4227b4a465084852cd87d8f23bec0db6fa7766b9685ab5e095ef9cda9e15e49d",
			),
		);
	...
	await test("Move leaf from left to right branch", () => {
		...
		trie.set(
			parseStateKey(
				"f1a9fcaf8ae0ff770b0908ebdee1daf8457c0ef5e1106c89ad364236333c5fb3",
			),
		...
		trie.set(
			parseStateKey(
				"f0a9fcaf8ae0ff770b0908ebdee1daf8457c0ef5e1106c89ad364236333c5fb3",
			),
			BytesBlob.parseBlob("0x1234"),
		);
		...
		const vector = {
			input: {
				...
				b05ff8a05bb23c0d7b177d47ce466ee58fd55c6a0351a3040cf3cbf5225aab19:
					"6a208734106f38b73880684b",
			},
			output:
				"55634c70b9dca56f2f40b343f750a5c9744798370cbf3f669e29ebe0b8d64ceb",
		};
