...
import { gasCounter, MemoryBuilder, Registers, tryAsGas, tryAsMemoryIndex, tryAsSbrkIndex } from "@typeberry/pvm-interpreter";
...
import { PreimageStatus, PreimageStatusResult } from "./partial-state";
...
describe("HostCalls: Query", () => {
    ...
    it("should return requested if preimage is requested", async () => {
        ...
        const w8 = tryAsU32(32);
        const data = Bytes.fill(HASH_SIZE, 0xAA).asOpaque();
        const status: PreimageStatusResult = { status: PreimageStatus.Requested };
    ...
    it("should return available if preimage is available", async () => {
        ...
        const status: PreimageStatusResult = { status: PreimageStatus.Available, data: [timeslot1] };
        accumulate.checkPreimageStatusResponse = status;
    ...
    it("should return unavailable if preimage is unavailable", async () => {
        ...
        const status: PreimageStatusResult = { status: PreimageStatus.Unavailable, data: [timeslot1, timeslot2] };
        accumulate.checkPreimageStatusResponse = status;
    ...
    it("should return reavailable if preimage is reavailable", async () => {
        ...
        const status: PreimageStatusResult = { status: PreimageStatus.Reavailable, data: [timeslot1, timeslot2, timeslot3] };
        accumulate.checkPreimageStatusResponse = status;
