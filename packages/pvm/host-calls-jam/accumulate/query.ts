import { HostCallHandler, Memory, PvmExecution, Registers } from "@typeberry/pvm-host-calls";
import { tryAsHostCallIndex } from "@typeberry/pvm-host-calls/host-call-handler";
import { Gas, GasCounter, tryAsMemoryIndex, tryAsSmallGas } from "@typeberry/pvm-interpreter";
import { WithOpaque } from "@typeberry/utils";
import { CURRENT_SERVICE_ID } from "../utils";
import { AccumulationPartialState, PreimageStatus } from "./partial-state";
import { Bytes } from "@typeberry/bytes";
import { HASH_SIZE } from "@typeberry/hash";
import { HostCallResult } from "../results";
import { tryAsU32 } from "@typeberry/numbers";
import { Pvm } from "../../debugger-adapter";
...
export class Query implements HostCallHandler {
    ...
    async execute(gas: GasCounter, regs: Registers, memory: Memory): Promise<PvmExecution | undefined> {
        // `o`
