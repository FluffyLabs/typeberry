  ...
  dispatch(instruction: Instruction, args: OneRegisterOneImmediateOneOffsetResult) {
    switch (instruction) {
      case Instruction.LOAD_IMM_JUMP:
        this.branchOps.loadImmediateJump(args.firstRegisterIndex, args.immediateDecoder1.getUnsigned(), args.offset);
        break;
      case Instruction.BRANCH_EQ_IMM:
        this.branchOps.branchEqImmediate(args.firstRegisterIndex, args.immediateDecoder1.getUnsigned(), args.offset);
        break;
      case Instruction.BRANCH_NE_IMM:
        this.branchOps.branchNeImmediate(args.firstRegisterIndex, args.immediateDecoder1.getUnsigned(), args.offset);
        break;
