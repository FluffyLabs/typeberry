...
describe("crypto.ed25519", () => {
  it('should produce a signature and verify it', async () => {
    ...
    assert.strictEqual(signature.toString(), "0x99a3ca1ebdaed52cce90360a5ed42b17a3d2b9a7a00d54b3d1c86dd515063fc48c339bbbd890a3c5373d9a16651da6de8e63cbf6034db417cc3e3538737e500e");
