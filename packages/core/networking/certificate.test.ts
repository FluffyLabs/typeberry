...
describe("X509 Certificate", () => {
  ...
  it("should validate certificate generated by openssl", async () => {
    ...
    const alicePair = await ed25519.privateKey(Bytes.fill(ed25519.ED25519_PRIV_KEY_BYTES, 0).asOpaque());
    ...
    deepEqual(
      verificationResult,
      Result.ok({
        id: "ehnvcppgow2sc2yvdvdicu3ynonsteflxdxrehjr2ybekdc2z3iuq",
        key: alicePair.pubKey,
      }),
    );
  });
});
