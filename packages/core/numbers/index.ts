...
/** Get the largest value between U64 a and values given as input parameters. */
export const maxU64 = (a: U64, ...values: U64[]): U64 => values.reduce((max, value) => (value > max ? value : max), a);
