...
describe('crypto.ed25519', () => {
  it('should verify a bunch of signatures', async () => {
    const results = await ed25519.verify(VALID_EXAMPLES.concat({
      ...VALID_EXAMPLES[0],
...
const VALID_EXAMPLES: ed25519.Input<BytesBlob>[] = [{
  signature: '0xa3afee85825aefb49cfe10000b72d22321f6d562f89f57f56da813f62761130774e2540b2c0ce33da3c28fcbffe52ea0d1eccfbd859be46835128c4cc87fb50c',
  ...
  signature: '0xdbd50734b049bcc9e25f5c4d2d2b635e22ec1d4eefcc324863de9e1673bacb4b7ac4424a946abae83755908a3f77470776c160e7d5b42991c1b8914bfc16b700',
