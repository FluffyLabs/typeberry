...
import { HashableBlob, PageAllocator, hashBytes } from ".";
...
describe("Hash", () => {
  it("should hash given set of bytes", () => {
    ...
    const hash = hashBytes(blob, allocator);

    assert.strictEqual(hash.toString(), "0x49f5a84b4c975b075b3be90fd3d1c024dce6575de10a1c0a6f77788503bb306d");
  });
});

describe("HashableBlob", () => {
  it("should lazily hash the blob", () => {
    const blob = new HashableBlob(
      BytesBlob.parseBlob("0x2fa3f686df876995167e7c2e5d74c4c7b6e48f8068fe0e44208344d480f7904c"),
      undefined,
      allocator,
    );
