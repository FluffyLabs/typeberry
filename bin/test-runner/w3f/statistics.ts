...
/**
 * Executes a statistics state transition test using the tiny chain specification.
 *
 * Initializes the statistics state from the provided pre-state, applies the input transition, and asserts that the resulting state matches the expected post-state.
 *
 * @param input - The input data for the state transition.
 * @param pre_state - The initial statistics state before the transition.
 * @param post_state - The expected statistics state after the transition.
 */
...
/**
 * Executes a statistics state transition test using the full chain specification.
 *
 * Initializes the statistics state from the provided pre-state, applies the input transition, and asserts that the resulting state matches the expected post-state.
 *
 * @param input - The input data for the state transition.
