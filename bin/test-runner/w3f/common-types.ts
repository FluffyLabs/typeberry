...
/**
 * Returns the appropriate chain specification object based on the provided path.
 *
 * If the {@link path} contains the substring "tiny", the tiny chain specification is returned; otherwise, the full chain specification is returned.
 *
 * @param path - The file path or identifier used to select the chain specification.
 * @returns The selected chain specification object.
 */
