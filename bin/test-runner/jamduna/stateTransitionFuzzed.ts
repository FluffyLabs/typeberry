...
const expectedErrors: { [key: string]: string | Awaited<ReturnType<OnChain["transition"]>> } = {
  ...
  "1_001_T5_EpochLotteryOver.json": safroleSealError(SafroleSealError.InvalidTicket),
  "1_001_T6_TimeslotNotMonotonic.json": safroleSealError(SafroleSealError.InvalidTicket),
  "1_002_T2_TicketAlreadyInState.json": safroleError(SafroleErrorCode.BadTicketOrder),
  "1_002_T5_EpochLotteryOver.json": safroleSealError(SafroleSealError.InvalidTicket),
  "1_002_T6_TimeslotNotMonotonic.json": safroleSealError(SafroleSealError.InvalidTicket),
  "1_003_T5_EpochLotteryOver.json": safroleSealError(SafroleSealError.InvalidTicket),
  "1_003_T6_TimeslotNotMonotonic.json": safroleSealError(SafroleSealError.InvalidTicket),
  "1_004_T2_TicketAlreadyInState.json": safroleError(SafroleErrorCode.BadTicketOrder),
  "1_004_T5_EpochLotteryOver.json": safroleSealError(SafroleSealError.InvalidTicket),
  "1_004_T6_TimeslotNotMonotonic.json": safroleSealError(SafroleSealError.InvalidTicket),
